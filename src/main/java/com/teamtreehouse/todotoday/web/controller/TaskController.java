...
public class TaskController {
    ...
    @RequestMapping({"/", "/todo"})
    public String taskList(Model model, Principal principal) { //username passsword token object
        // principal.getName() would return username of logged in user
    ...
    public String addTask(@ModelAttribute Task task, Principal principal) {
        //User user = userService.findByUsername(principal.getName()); - unneeded hit to the db
